            ...
            <div class="col-md-3">
                <div class="single-populer-products">
                    <div class="single-populer-product-img mt40">
                        <img src="{{ asset('front_assets') }}/images/populer-products/p1.png" alt="populer-products images">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="single-inner-populer-product-img">
                                    <img src="{{ asset('front_assets') }}/images/populer-products/p2.png"
                ...
                <div class="single-populer-products">
                    <div class="single-populer-products">
                        <div class="single-populer-product-img">
                            <img src="{{ asset('front_assets') }}/images/populer-products/p3.png" alt="populer-products images">
                        </div>
