                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            <button class="btn btn-sm btn-primary me-2 edit-btn" data-id="{{ $item->id }}"
                                                ...
                                                data-discount_price="{{ $item->discount_price }}" data-slug="{{ $item->slug }}"
                                                data-weight="{{ $item->weight }}" data-dimensions="{{ $item->dimensions }}"
            ...
            editBtns.forEach(btn => {
                btn.addEventListener('click', function () {
                    ...
                    console.log('Editing product:', {
                        id, productCode, productName, price, category, stock, description, image, status, discountPrice, slug, weight, dimensions, onSale
                    });
